package br.com.lunacom.sapep.resources.exceptions;

import javax.servlet.http.HttpServletRequest;

import br.com.lunacom.sapep.services.exceptions.AuthorizationException;
import br.com.lunacom.sapep.services.exceptions.DataIntegrityException;
import br.com.lunacom.sapep.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> dataIntegrity(DataIntegrityException e, HttpServletRequest request) {
		...
		StandardError err = new StandardError(System.currentTimeMillis(),
				HttpStatus.BAD_REQUEST.value(), "Integridade de dados", e.getMessage(), request.getRequestURI());
